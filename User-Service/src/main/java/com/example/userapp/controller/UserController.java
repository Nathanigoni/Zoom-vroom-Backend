...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<UserClass> login(@RequestBody UserClass user) {
        UserClass response = service.verify(user);
        return ResponseEntity.ok(response); // ✅ this sends only safe data
    }
